    ...
    <div className='min-h-screen bg-white border-r'>
...

      {
        pToken  && <ul className='text-[#515151] mt-5'>
          <NavLink to='/provider/dashboard' className={({isActive}) => `flex itms-center gap-4 py-3.5 px-3 md:px-9 md:min-w-72 cursoir-pointer ${isActive ? 'bg-[#F2F2FF] border-r-4 border-[#5F6FFF]' : ''}`}>
            <img src={assets.home_icon} />
            <p className='hidden md:block'>Dashboard</p>
          </NavLink>
          
          <NavLink to='/provider/all-appointments' className={({isActive}) => `flex itms-center gap-4 py-3.5 px-3 md:px-9 md:min-w-72 cursoir-pointer ${isActive ? 'bg-[#F2F2FF] border-r-4 border-[#5F6FFF]' : ''}`}>
            <img src={assets.appointment_icon} />
            <p className='hidden md:block'>Appointments</p>
          </NavLink>

          <NavLink to='/provider/my-profile' className={({isActive}) => `flex itms-center gap-4 py-3.5 px-3 md:px-9 md:min-w-72 cursoir-pointer ${isActive ? 'bg-[#F2F2FF] border-r-4 border-[#5F6FFF]' : ''}`}>
            <img src={assets.add_icon} />
