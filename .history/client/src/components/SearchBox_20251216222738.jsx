...
const SearchBox = () => {
  return (
    <div className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2 shadow-sm max-w-2xl w-2xl mx-auto">
      <select
      ...
      <input
        ...
        className="flex-1 bg-transparent text-sm text-sky-900 placeholder:text-slate-300 focus:outline-none px-1"
      />
