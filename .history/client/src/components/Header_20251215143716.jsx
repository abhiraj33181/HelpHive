import { ArrowRight, Calendar, HandHelpingIcon } from 'lucide-react'
            ...
            <div className='container mx-auto px-4 h-16 flex items-center justify-between'>
                ...
                >
                  Logout
                        ...
                        <button onClick={() => navigate('/auth/login')} className='md:flex gap-2 justify-center items-center bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 cursor-pointer text-white px-8 py-3 rounded-full hidden transition-all duration-300 shadow-md hover:shadow-lg font-medium'>Get Started <ArrowRight /></button>
                    )}
