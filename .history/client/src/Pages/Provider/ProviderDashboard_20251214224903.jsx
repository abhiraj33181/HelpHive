  ...
  {selectedAppointment && (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-4xl w-full">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-5 text-white">
        <h1 className="text-2xl font-bold tracking-wide">Booking Details</h1>
        <p className="text-sm opacity-90">Appointment Information</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 p-6">
        ...
        <img
          ...
          alt="User"
          className="hidden md:block w-64 h-80 rounded-xl object-cover border"
        />
        ...
        <div className="flex-1">
          ...
          <div className="space-y-3">
            ...
            <p className="flex gap-2 text-gray-600">
              <MapPin className="min-w-5 text-red-500" />
              <span>
                {selectedAppointment.userData.address.street},{" "}
                {selectedAppointment.userData.address.city},
                <br />
                {selectedAppointment.userData.address.state} -{" "}
                {selectedAppointment.userData.address.pincode}
              </span>
            </p>

            <div className="flex flex-wrap gap-2 mt-2">
              <span className="px-3 py-1 rounded-full text-sm bg-blue-100 text-blue-700 border">
                {selectedAppointment.provData.service}
              </span>

              <span className="px-3 py-1 rounded-full text-sm bg-green-100 text-green-700 border">
          ...
          {/* Connect Section */}
          <div>
            <h2 className="font-semibold mb-2">Connect with User</h2>
            <div className="flex gap-3">
              <button
                onClick={() =>
                  (window.location.href = `tel:${selectedAppointment.userData.phone}`)
                }
                className="icon-btn bg-blue-100 text-blue-600 hover:bg-blue-600"
              >
                <Phone />
              </button>
              ...
              <button
                ...
                className="icon-btn bg-green-100 text-green-600 hover:bg-green-600"
              >
                <MessageCircleMore />
              </button>

              <button className="icon-btn bg-amber-100 text-amber-600 hover:bg-amber-600">
                <MapPin />
              </button>
            </div>
          </div>
            ...
            <p>
              ...
              <span
                className={`px-3 py-1 rounded-full text-sm border ${
                  ...
                  selectedAppointment.isAccepted === "Appointment Request Cancelled"
