                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="p-5 rounded-2xl border-2 bg-gradient-to-br from-gray-50 to-white/50">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className={`w-3 h-3 rounded-full ${selectedAppointment.isAccepted === 'Pending' || selectedAppointment.isAccepted === 'Appointment Request Cancelled'
                              ? 'bg-amber-400'
                              : 'bg-emerald-500'
                            } animate-pulse`} />
                        </div>
                        <span className={`px-4 py-2 rounded-full text-sm font-bold ${selectedAppointment.isAccepted === 'Pending' || selectedAppointment.isAccepted === 'Appointment Request Cancelled'
                      ...
                      <div className="p-5 rounded-2xl border-2 bg-gradient-to-br from-gray-50 to-white/50">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className={`w-3 h-3 rounded-full ${selectedAppointment.payment ? 'bg-emerald-500' : 'bg-red-500'
                            } animate-pulse`} />
                        </div>
                        <span className={`px-4 py-2 rounded-full text-sm font-bold w-full text-center block ${selectedAppointment.payment
                            ? 'bg-emerald-100 text-emerald-800 border-2 border-emerald-200'
