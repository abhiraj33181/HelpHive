...
const ProviderDashboard = () => {
  ...
  {selectedAppointment && (
    <div className="space-y-6 max-w-sm sm:max-w-md">
      {/* Profile */}
      <div className="flex items-center gap-4 p-6 rounded-2xl bg-gray-50 border">
      ...
      {/* Service & Price */}
      <div className="p-5 rounded-2xl bg-gradient-to-r from-indigo-50 to-gray-50 border">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <button 
            ...
            className="p-4 rounded-xl bg-blue-500 text-white hover:bg-blue-600 shadow-md hover:shadow-lg transition-all flex flex-col items-center gap-2 h-20"
          >
          ...
          <button 
            ...
            className="p-4 rounded-xl bg-emerald-500 text-white hover:bg-emerald-600 shadow-md hover:shadow-lg transition-all flex flex-col items-center gap-2 h-20"
          >
            <MessageCircleMore className="h-6 w-6" />
            <span className="text-xs font-medium">Chat</span>
          </button>
          
          <button className="p-4 rounded-xl bg-gray-100 text-gray-500 hover:bg-gray-200 shadow-md hover:shadow-lg transition-all flex flex-col items-center gap-2 h-20">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-4 rounded-xl border bg-gray-50">
          ...
          <span className={`px-3 py-2 rounded-lg text-sm font-semibold block text-center ${
            selectedAppointment.isAccepted === 'Pending' || selectedAppointment.isAccepted === 'Appointment Request Cancelled'
      ...
      {selectedAppointment.isAccepted === 'Pending' && (
        <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-200">
          <button 
            ...
            className="py-4 px-6 bg-emerald-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all text-sm"
          >
            Accept
          </button>
          <button 
            onClick={() => updateAppointmentStatus(selectedAppointment._id, 'Appointment Request Cancelled')}
            className="py-4 px-6 bg-red-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all text-sm"
          >
            Reject
          </button>
        </div>
