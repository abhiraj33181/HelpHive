    ...
    <div className='px-4 py-10 sm:mx-[10%] md:mx-10'>
      ...
      <div className='flex flex-col md:flex-row gap-10 w-full my-12 items-start'>
        ...
        <Modal isOpen={open} onClose={() => { setSelectedAppointment(null); setOpen(false) }}>
          {selectedAppointment && (
            !complete ? (
              ...
              <form class="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-6 space-y-6">

                <div>
                  <h2 class="text-2xl font-semibold text-gray-800">Complete Job</h2>
                ...
                <div>
                  ...
                  <div class="flex gap-4">
                    <label class="flex items-center gap-2">
                      <input type="radio" name="status" class="accent-blue-600" checked />
                      <span>Completed Successfully</span>
                    </label>
                    <label class="flex items-center gap-2">
                      <input type="radio" name="status" class="accent-blue-600" />
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">
                    Work Summary <span class="text-red-500">*</span>
                  </label>
                  <textarea
                    rows="3"
        ...
        hover:file:bg-blue-100"
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">
                    Provider Remark (optional)
                  </label>
                  <textarea
                    rows="2"
                    placeholder="Any note for the user or admin"
                    class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 outline-none"
                  ></textarea>
                </div>
