        ...
        <Modal isOpen={open} onClose={() => { setSelectedAppointment(null); setOpen(false) }}>
          {selectedAppointment && (
            !complete ? (
              ...
              <div class="w-full rounded-2xl space-y-6">
                ...
                <div className="flex gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={() => setCompleteStatus("completed")}
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      name="status"
                      value="issue"
                      checked={completeStatus === "issue"}
                      onChange={() => setCompleteStatus("issue")}
                      className="accent-blue-600"
                    />
                ...
                <div class="flex justify-end gap-3 pt-4">
                  ...
                  <button
                  onClick={(e) => {
                    completeAppointment(selectedAppointment._id, completeStatus = completeStatus, remarks = remark, extraCharge, extraChargeReason)
                  }}
                    type="submit"
