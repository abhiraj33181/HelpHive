    ...
    <div className="mx-4 sm:mx-[10%] py-16 min-h-screen mt-5 ">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-5 justify-center items-center">
          ...
          <button className='text-sm bg-slate-800 text-white hover:bg-slate-900 cursor-pointer flex items-center justify-center gap-1 py-1 px-2 rounded outline-0'><Plus className='h-4' />List Shop</button>
        </div>
      </div>
