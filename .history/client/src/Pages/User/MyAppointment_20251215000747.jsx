        ...
        <div>
            <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
                <form class="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-6 space-y-6">
                    ...
                    <div>
                        <h2 class="text-2xl font-semibold text-gray-800">Book a Service</h2>
                    ...
                    <div>
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="urgency" checked class="accent-blue-600" />
                                <span>Normal</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="urgency" class="accent-blue-600" />
                                <span>Urgent</span>
                            </label>
                        </div>
                    </div>
